...
try {
  contextBridge.exposeInMainWorld("api", {
    ...
    beginRewardOverlayEdit: inv<"beginRewardOverlayEdit">(REWARD_EDIT_BEGIN),
    getRewardOverlayPreview: inv<"getRewardOverlayPreview">(REWARD_EDIT_PREVIEW),
    updateRewardOverlayEdit: inv<"updateRewardOverlayEdit">(REWARD_EDIT_UPDATE),
    endRewardOverlayEdit: inv<"endRewardOverlayEdit">(REWARD_EDIT_END),
    onRewardOverlayEditState: ipcDataBridge<IpcEventMap["reward-overlay-edit-state"]>(
      ipcRenderer,
      REWARD_EDIT_STATE,
    ),
